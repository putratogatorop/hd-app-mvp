...
import { getGiftMetrics, type GiftMetrics } from '@/lib/dashboard/real-metrics'
...
export default function GiftPage() {
  ...
  const [state, setState] = useState<{ metrics: GiftMetrics; stores: FilterBarStore[] } | null>(null)
  ...
  return <GiftPageClient metrics={state.metrics} stores={state.stores} />
}
